...
<div>
    ...
    >
        <nav
                class="fixed after:pointer-events-none after:absolute after:inset-x-0 after:bottom-0 after:h-px bg-stone-600/70 lg:p-2 md:mr-10 md:ml-5 rounded-full"
        >
            <div class="lg:mx-auto lg:px-2 lg:flex items-center justify-center md:grid lg:grid-flow-col md:grid-flow-row lg:grid-rows-3 md:grid-rows-1 lg:p-1">
               <div>
